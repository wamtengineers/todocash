	...
	<h1 class="title">Manage Configuration Variables</h1>
  	...
  	<div class="right">
    	<div class="btn-group" role="group" aria-label="..."> 
        	<a href="config_variable_manage.php?tab=add" class="btn btn-light editproject">Add New Record</a> 
    	...
    	<tbody>
            ...
            if(numrows($rs)>0){
                ...
                <tr>
                    ...
                    <td colspan="3" class="paging" title="Paging" align="right"><?php echo pages_list($rows, "config_variable", $sql, $pageNum)?></td>
                </tr>
                <?php	
            }
            else{	
