            ...
            if(numrows($rs)>0){
                ...
                while($r=dofetch($rs)){             
                    ...
                    <tr>
                        ...
                        <td><?php if($r["parent_id"]==0) echo "No Parent"; else echo get_field($r["parent_id"], "item_category","title");?></td>
                ...
                <tr>
                    ...
                    <td colspan="3" class="paging" title="Paging" align="right"><?php echo pages_list($rows, "item_category", $sql, $pageNum)?></td>
                </tr>
                <?php	
            }
            else{	
