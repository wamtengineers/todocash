...
<form class="form-horizontal form-horizontal-left" role="form" action="admin_type_manage.php?tab=edit" method="post" enctype="multipart/form-data" name="frmAdd">
    ...
    <div class="clearfix form-group">
        <div class="row">
            ...
            <div class="col-md-10">
                <button class="btn btn-default btn-l" type="submit" name="admin_type_edit" title="Submit Record">
