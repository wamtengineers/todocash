...
<div class="panel-body table-responsive">
	<table class="table table-hover list">
    	...
    	<tbody>
			<?php 
            $sql="select * from customer where 1 $extra";
            ...
            if(numrows($rs)>0){
                ...
                while($r=dofetch($rs)){             
                    ...
                    <tr>
                        ...
                        <td class="text-center"><a href="customer_manage.php?id=<?php echo $r['id'];?>&tab=status&s=<?php echo ($r["status"]==0)?1:0;?>">
                            <?php
                            if($r["status"]==0){
                                ?>
                ...
                <tr>
                    ...
                    <td colspan="3" class="paging" title="Paging" align="right"><?php echo pages_list($rows, "customer", $sql, $pageNum)?></td>
                </tr>
                <?php	
            }
            else{	
