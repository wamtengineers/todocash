...
<form action="sales_manage.php?tab=edit" method="post" enctype="multipart/form-data" name="frmAdd"  onSubmit="return checkFields();" class="form-horizontal form-horizontal-left">
    ...
    <div class="form-group">
                    ...
                    <table class="table table-hover list">
                        ...
                        <tbody>
                                            	...
                                            	if(numrows($res)>0){
                                                	...
                                                	<optgroup label="<?php echo unslash($rec["title"]); ?>">
                                                        ...
                                                        if(numrows($subCat)>0){
                                                            ...
                                                            ?>
                                                            <option value="<?php echo $subCatName["id"]?>" <?php if($items[$sn-1]==$subCatName["id"]) echo ' selected="selected"';?>><?php echo unslash($subCatName["title"]); ?></option>
                                                            <?php
                                                            }
                                                        }
                                                        ?>
                            ...
                            <tr class="sale_item">
                                ...
                                <td class="text-right"><input type="text"  name="unit_price[]" id="unit_price<?php echo $sn?>" class="unit_price"  readonly="readonly" value="" /></td>
  	...
  	<div class="form-group">
    	<div class="row">
            ...
            <div class="col-sm-10">
                <input type="submit" value="SUBMIT" class="btn btn-default btn-l" name="sales_edit" title="Submit Record" />
            </div>
        </div>
  	</div>
</form>